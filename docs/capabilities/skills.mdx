...
|---------------|--------------------------------------------------------------|----------------------------------------------------------|
| **Trusted**   | System and user skill roots                                  | Model can auto-select via `skill_activate`               |
| **Installed** | Lower-trust skill bundles, including the tenant-shared root when enabled | Excluded from `skill_activate`. Available via explicit `$name` mention. |
